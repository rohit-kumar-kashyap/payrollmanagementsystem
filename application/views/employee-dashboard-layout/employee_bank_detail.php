    ...
    <div class="container-fluid">
        <div class="card col-md-8">
            <div class="header_title">
                <h4 class="title" style="text-align:center;">Your Bank Details</h4>
            </div>
            ...
            <div class="content">
                <form class="form-horizontal" method="POST" action="<?php echo base_url('empbankdetails/updateformdetails');?>" enctype="multipart/form-data" id="empbankformUpdate" style="padding:25px;">
                    <input type="hidden" class="form-control" id="rowid" name="rowid" value="<?php echo $rowid;?>">
                    <input type="hidden" class="form-control" id="employeeid" name="employeeid" value="<?php echo $emp_id;?>">
...
<script src="<?php echo base_url('assets/dashboard-assets/js/employeebankdetailsjs/custom.js');?>"></script>